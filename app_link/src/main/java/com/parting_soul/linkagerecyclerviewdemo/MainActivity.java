...
public class MainActivity extends AppCompatActivity {
    ...
    private void changeLeftListSelectState() {
        ...
        if (bean != null) {
            int leftItemPositionBySortName = findLeftItemPositionBySortName(bean.getGroupName());
            mLeftAdapter.setSelectPosition(leftItemPositionBySortName);
            mRvLeft.smoothScrollToPosition(leftItemPositionBySortName);
